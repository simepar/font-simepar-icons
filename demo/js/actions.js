...
$('#plus-sign').click(function () {
  if (frames_s > 200) {
    ...
    signal_icon.className = 'icon-simepar-signal-lvl-' + current_lvl;
    clearInterval(setIntervalID);
    animate();
  } else {
    signal_icon.className = 'icon-simepar-signal-lvl-10';
  }
});
...
$('#minus-sign').click(function () {
  if (frames_s < 2000) {
    ...
    signal_icon.className = 'icon-simepar-signal-lvl-1';
  }
});
